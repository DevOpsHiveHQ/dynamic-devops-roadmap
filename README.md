...
**MyHiveBox** is a Cloud-Native IoT monitoring API designed to demonstrate modern DevOps practices. It fetches real-time temperature data from openSenseMap sensors, analyzes it, and exposes Prometheus metrics.
...
3. **Security Scan:** Scans Kubernetes manifests for vulnerabilities using **Trivy** (Checks for root access, privileges, etc.).
